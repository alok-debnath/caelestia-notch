...
PageBase {
    ...
    ColumnLayout {
        ...
        NavRow {
            ...
            icon: "sensors"
            text: qsTr("Island")
            subtext: IslandConfig.hoverAction === IslandConfig.HoverAction.None ? qsTr("Hover does nothing") : IslandConfig.hoverAction === IslandConfig.HoverAction.Player ? qsTr("Hover opens now playing") : qsTr("Hover opens now playing, or notification history")
